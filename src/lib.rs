// src/lib.rs
/*
 * Core library for CloudformationTemplates
 */
...
#[derive(Debug)]
pub struct CloudformationTemplatesProcessor {
    verbose: bool,
    processed_count: usize,
}

impl CloudformationTemplatesProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting CloudformationTemplates processing");
    
    let mut processor = CloudformationTemplatesProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = CloudformationTemplatesProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = CloudformationTemplatesProcessor::new(false);
